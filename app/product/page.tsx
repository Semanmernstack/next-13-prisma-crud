...
async function page() {
  ...
  return (
    <div className='p-5 bg-zinc-700 '>
        ...
        <thead className="bg-purple-600 shadow-black shadow-2xl p-6 text-white">
        ...
        <tbody className=" items-center text-center rounded-md p-3 bg-slate-400 shadow-xl font-medium ">
