...
function AddPrisma() {
  ...
  return (
    <div className=' mx-auto max-w-7xl'>
        ...
        <form className=" flex flex-col items-center justify-center   decoration-slate-400 p-5 z-50" >
            ...
            <div className='flex flex-col space-y-3'>
                <label >Price</label>
                <input className='w-ful bg-slate-300 rounded-md' type="text" value={price} onChange={(e) => setPrice(e.target.value)} />
            </div>
