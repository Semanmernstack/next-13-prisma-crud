...
function DeletePrisma({ product }: {product: Product} ) {
  ...
  return (
    <div className='relative bg-blue-900 p-2 '>
        <button className='items-center justify-center flex bg-purple-800 p-1 cursor-pointer ' onClick={() => setOpen(true)}>Delete</button>
        {open ? (
            <div className=" text-xs text-white  p-1  absolute  mx-auto max-w-2xl justify-center items-center top-20 right-0 bottom-0 z-100">
