...
function AddPrisma({ brands }: {brands: Brand[]}) {
  ...
  return (
    <div className='relative  '>
        <button className='items-center bg-zinc-900 text-white  justify-center flex cursor-pointer  p-2 animate-pulse shadow-xl' onClick={() => setOpen(true)}>Add New Product</button>
        {open ? (
