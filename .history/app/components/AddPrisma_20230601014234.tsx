...
function AddPrisma() {
  ...
  return (
    <div className='relative '>
        ...
        {open ? (
            <div className="absolute justify-center items-center inset-0 ">
                <form className=" flex flex-col mx-auto max-w-6xl justify-center items-center inset-0   decoration-slate-400 p-5 z-50" >
